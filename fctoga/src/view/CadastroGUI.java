...
public class CadastroGUI {
    ...
    public static JFrame render(boolean permitirApenasAdministrador) {
        ...
        c.gridx = 0; c.gridy = 0; frame.add(tipoUsuarioLabel, c);
        c.gridx = 1; c.gridy = 0; frame.add(tipoUsuario, c);
        c.gridx = 0; c.gridy = 1; frame.add(cpfLabel, c);
        c.gridx = 1; c.gridy = 1; frame.add(cpfField, c);
        c.gridx = 0; c.gridy = 2; frame.add(nomeLabel, c);
        c.gridx = 1; c.gridy = 2; frame.add(nomeField, c);
        c.gridx = 0; c.gridy = 3; frame.add(senhaLabel, c);
        c.gridx = 1; c.gridy = 3; frame.add(senhaField, c);
        c.gridx = 0; c.gridy = 4; frame.add(comarcaLabel, c);
        c.gridx = 1; c.gridy = 4; frame.add(comarcaField, c);
        c.gridx = 0; c.gridy = 5; frame.add(numeroOABLabel, c);
        c.gridx = 1; c.gridy = 5; frame.add(numeroOABField, c);
        c.gridx = 0; c.gridy = 6; frame.add(estadoOABLabel, c);
        c.gridx = 1; c.gridy = 6; frame.add(estadoOAB, c);
        c.gridx = 0; c.gridy = 7; c.gridwidth = 2; frame.add(cadastrarButton, c);
        frame.pack();
